...
var getRandomSeed = function() {
    var ourRandom = crypto.randomBytes(16).toString('hex');
    // if our pool is empty, use the date stamp as the has key
    return sha512hmac(ourRandom,new Date().toISOString());
};
...
module.exports = {
    ...
    getHashRand: getHashRand,
    randToValue: randToValue
};
